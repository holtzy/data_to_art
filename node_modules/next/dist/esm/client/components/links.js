...
function rescheduleLinkPrefetch(instance, priority) {
    ...
    if (appRouterState !== null) {
        ...
        if (existingPrefetchTask === null) {
            ...
            instance.prefetchTask = scheduleSegmentPrefetchTask(cacheKey, treeAtTimeOfPrefetch, instance.kind === PrefetchKind.FULL, priority, null);
        } else {
...
export function pingVisibleLinks(nextUrl, tree) {
    ...
    for (const instance of prefetchableAndVisible){
        ...
        const cacheKey = createCacheKey(instance.prefetchHref, nextUrl);
        instance.prefetchTask = scheduleSegmentPrefetchTask(cacheKey, tree, instance.kind === PrefetchKind.FULL, PrefetchPriority.Default, null);
    }
}
