        ...
        const clientBuildManifest = {
            ...
            ...Object.fromEntries(sortedPageKeys.map((pathname)=>{
                ...
                return [
                    pathname,
                    [
                        "static/chunks/pages" + filePath
                    ]
                ];
            })),
            sortedPages: sortedPageKeys
        };
        const clientBuildManifestJs = "self.__BUILD_MANIFEST = " + JSON.stringify(clientBuildManifest) + ";self.__BUILD_MANIFEST_CB && self.__BUILD_MANIFEST_CB()";
